...
BEGIN
  ...
  INSERT INTO public.pipeline_historico (
    pipeline_lead_id,
    stage_anterior_id,
    stage_novo_id,
    movido_por,
  ...
  VALUES (
    ...
    v_stage_novo_lead,
    v_movido_por,
    '🔄 REATIVADO POR NUTRIÇÃO — resposta positiva no disparo. Origem original: ' || v_origem_atual || '. Retornado para a roleta como Novo Lead.'
  );

  BEGIN
    SELECT public.distribuir_lead_atomico(p_lead_id, NULL, NULL, false)
      INTO v_dist;
