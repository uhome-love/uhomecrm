...
CREATE OR REPLACE FUNCTION public.processar_cadencia_sem_contato()
 RETURNS TABLE(lead_id uuid, corretor_id uuid, numero integer, acao text, canal text, texto_app text, texto_whatsapp text, lead_nome text, empreendimento text, telefone text, do_descarte boolean, proxima_em timestamptz)
 LANGUAGE plpgsql
 SECURITY DEFINER
