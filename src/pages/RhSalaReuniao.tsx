...
import { Plus, CalendarDays, Clock, Trash2, Pencil, Video } from "lucide-react";
...
export default function RhSalaReuniao() {
  ...
  return (
    <div className="bg-[#f0f0f5] dark:bg-background p-6 -m-6 min-h-full space-y-4 max-w-4xl mx-auto">
      <PageHeader
        title="Sala de reunião"
        subtitle="Reserva de espaços"
        icon={<Video size={18} strokeWidth={1.5} />}
        actions={
          <Button onClick={openAdd} size="sm" className="bg-primary hover:bg-primary text-white gap-1">
