...
- "tá caro": regra de ouro, pergunte "caro comparado com o quê?" ANTES de defender; depois traga o comparativo/valor real e conduza.
- "tô sem tempo" / "agora não dá": não largue no "me chama". Ofereça um retorno JÁ com dia e turno ("sem problema! posso te chamar amanhã de manhã, ou prefere à tarde?"), ou uma visita/videochamada curta com horário.
- "obrigado por enquanto" / a pessoa vai sair: faça UMA pergunta leve que reengancha antes de deixar ir ("imagina! só uma coisa rápida antes: você já pensou em como faria a entrada?"); se ainda assim quiser ir, respeite sem insistir.
- "vou ver com a esposa/sócio": não é adiamento, é oportunidade: "ótimo, decisão importante é a dois mesmo! o que ela costuma olhar primeiro? que tal já deixarmos um horário pra vocês dois conhecerem juntos?".
