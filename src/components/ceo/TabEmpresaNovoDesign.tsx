...
export default function TabEmpresaNovoDesign() {
        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {teamData.map(t => {
              ...
              return (
                <Card key={t.gerente.user_id} className="overflow-hidden border-0 rounded-2xl bg-white dark:bg-[#141e30] shadow-[0_2px_14px_rgba(15,23,42,0.06)] hover:shadow-[0_10px_30px_rgba(73,105,255,0.12)] transition-shadow" style={{ borderTopColor: t.gerente.cor }}>
          ...
          {/* Comparativo */}
          <Card className="border-0 rounded-2xl bg-white dark:bg-[#141e30] shadow-[0_2px_14px_rgba(15,23,42,0.06)] hover:shadow-[0_10px_30px_rgba(73,105,255,0.12)] transition-shadow">
          ...
          {/* Top 10 Ranking */}
          {ranking.length > 0 && (
            <Card className="border-0 rounded-2xl bg-white dark:bg-[#141e30] shadow-[0_2px_14px_rgba(15,23,42,0.06)] hover:shadow-[0_10px_30px_rgba(73,105,255,0.12)] overflow-hidden transition-shadow">
              <CardContent className="p-0">
                <div className="px-4 py-3 border-b border-border flex items-center gap-2">
                  <Trophy size={14} className="text-primary" />
                  <h3 className="text-[15px] font-semibold tracking-tight text-foreground">Top 10 corretores da empresa</h3>
                </div>
...
function KpiBox({ icon, label, value, highlight }: { icon: React.ReactNode; label: string; value: string; highlight?: boolean }) {
  return (
    <div className="bg-white dark:bg-[#141e30] rounded-2xl p-4 border-0 shadow-[0_2px_14px_rgba(15,23,42,0.06)] hover:shadow-[0_10px_30px_rgba(73,105,255,0.15)] transition-shadow">
