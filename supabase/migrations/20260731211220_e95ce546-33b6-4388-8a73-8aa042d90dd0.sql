...
BEGIN
  ...
  -- Prioridade: corretores ALOCADOS ao produto. Se não houver ninguém alocado
  -- (ou produto não reconhecido), cai no rodízio geral por segmento.
  -- Fila do CEO só quando NÃO houver nenhum corretor disponível.
