...
DECLARE
  ...
  v_seg_casa_tua uuid := 'c8b24415-3dc1-4f65-aae1-f308ef02cb7a'; -- Médio-Alto Padrão (Casa Tua)
...
BEGIN
  ...
  v_nova_obs := concat(
    ...
    CASE WHEN v_is_casatua THEN ' Segmento foco: Casa Tua (Médio-Alto Padrão).' ELSE '' END,
  ...
  RETURN jsonb_build_object(
    ...
    'template', v_tpl,
    'segmento_foco', CASE WHEN v_is_casatua THEN 'Casa Tua' ELSE NULL END,
