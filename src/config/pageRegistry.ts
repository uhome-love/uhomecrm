...
export const PAGE_COMPONENTS: Record<string, React.LazyExoticComponent<any>> = {
  ...
  "central-usuarios": lazyRetry(() => import("@/pages/MeuTime")),
...
export const ROUTE_TO_TAB: Record<string, TabRouteConfig> = {
  ...
  "/central-usuarios":                { key: "central-usuarios",       label: "Meu Time",            icon: "Users",         roles: ["gestor", "admin", "diretor"] },
  ...
  "/dados-anuncios":                { key: "relatorio-origem-performance", label: "Dados Anúncios", icon: "BarChart2", roles: ["admin", "gestor", "diretor"], noPadding: true },
  "/relatorio-performance-origem":  { key: "relatorio-origem-performance", label: "Dados Anúncios", icon: "BarChart2", roles: ["admin", "gestor", "diretor"], noPadding: true },
