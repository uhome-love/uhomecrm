...
const TEMPLATE_HEADER_IMAGES: Record<string, string> = {
  ...
  casatuacanoas_novidade: "https://api.uhomesales.com/storage/v1/object/public/campaign-images/reengajamento/casatuacanoas-novidade.png",
  ...
  convite_decorado_lake_baikal: "https://api.uhomesales.com/storage/v1/object/public/campaign-images/reengajamento/convitedecoradolakebaikal.png",
  ...
  awa_disparo2: "https://api.uhomesales.com/storage/v1/object/public/campaign-images/reengajamento/awa-disparo2.png",
};
            ...
            <Tabs value={tab} onValueChange={(v) => setTab(v as typeof tab)}>
              ...
              <TabsContent value="filtros" className="space-y-3 pt-3">
                ...
                {has("base_unica") && (
                  <BaseUnicaFiltros
                    filtro={baseFiltro}
                    onChange={(patch) => setBaseFiltro((p) => ({ ...p, ...patch }))}
                    empreendimentos={(empreendimentosCanonicos || []).map((e) => ({ id: e.id, nome: e.nome }))}
                    formularios={(formulariosBase || []).map((f) => ({ formulario: f.formulario, total_leads: f.total_leads }))}
                    contagens={preview?.funil?.fonte === "base_unica" ? preview.funil : null}
                  />
                )}
