...
export const PAGE_COMPONENTS: Record<string, React.LazyExoticComponent<any>> = {
  ...
  "central-usuarios": lazyRetry(() => import("@/pages/CentralUsuariosPage")),
...
export const ROUTE_TO_TAB: Record<string, TabRouteConfig> = {
  ...
  "/central-usuarios":                { key: "central-usuarios",       label: "Usuários",            icon: "Users",         roles: ["gestor", "admin", "diretor"] },
  ...
  "/central-relatorios":        { key: "report-center",     label: "Central Relatórios",  icon: "BarChart2",     roles: ["admin", "gestor", "corretor"], noPadding: true },
