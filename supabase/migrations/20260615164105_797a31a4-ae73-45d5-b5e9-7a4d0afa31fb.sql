...
DECLARE
  ...
  v_seg_foco uuid := '5311aaaa-0000-4000-8000-000000000005'; -- Segmento FOCO (s5 - produto foco / Casa Tua)
...
BEGIN
  ...
  v_seg_id := CASE WHEN v_is_casatua THEN v_seg_foco ELSE v_lead.segmento_id END;
  ...
  v_nova_obs := concat(
    ...
    CASE WHEN v_is_casatua THEN ' Segmento FOCO (s5 - produto foco / Casa Tua).' ELSE '' END,
  ...
  RETURN jsonb_build_object(
    ...
    'template', v_tpl,
    'segmento_foco', CASE WHEN v_is_casatua THEN 'FOCO (s5)' ELSE NULL END,
