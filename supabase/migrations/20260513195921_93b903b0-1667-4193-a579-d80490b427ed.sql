-- Fix: reciclar_leads_sem_contato referenced inexistent column "aceite_at".
-- Correct column on pipeline_leads is "aceito_em". This was breaking the
-- lead-escalation cron every minute and stopping all redistribution.
