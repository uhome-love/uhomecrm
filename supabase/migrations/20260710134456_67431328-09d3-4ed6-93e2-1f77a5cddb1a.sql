-- Atualiza reativar_lead_para_fila_ceo: adiciona Flow (S4-MCMV) e realinha
-- Casa Tua/Vivid → S1-Moradia, Lake → S3-Alto Padrão (após padronização dos segmentos).
...
BEGIN
  ...
  ELSIF v_is_lake THEN
    v_seg_id := v_seg_alto; -- S3 - Alto Padrão
...
-- Atualiza reativar_oferta_ativa_para_fila_ceo: adiciona Flow (S4-MCMV) e realinha
-- Casa Tua/Vivid → S1-Moradia, Lake → S3-Alto Padrão.
