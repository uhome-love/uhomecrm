...
export const PAGE_COMPONENTS: Record<string, React.LazyExoticComponent<any>> = {
  ...
  "relatorio-geral": lazyRetry(() => import("@/pages/RelatorioGeral")),
  "raio-x-corretor": lazyRetry(() => import("@/pages/RaioXCorretorPage")),
  ...
  "relatorios-hub": lazyRetry(() => import("@/pages/Relatorios")),
...
export const ROUTE_TO_TAB: Record<string, TabRouteConfig> = {
  ...
  "/relatorio-geral":       { key: "relatorio-geral",      label: "Raio-X do Time",      icon: "ChartColumn",     roles: ["gestor", "admin", "diretor"] },
  "/raio-x-corretor":       { key: "raio-x-corretor",      label: "Raio-X do Corretor",  icon: "UserSearch",    roles: ["gestor", "admin", "diretor"] },
  ...
  "/raio-x":                { key: "relatorios-hub",       label: "Relatórios",          icon: "ChartColumn",     roles: ["gestor", "admin", "diretor", "corretor"] },
  ...
  "/recrutamento/acompanhamento": { key: "recrutamento-acompanhamento", label: "Recrutamento", icon: "ChartColumn", roles: ["admin", "diretor"] },
  ...
  "/central-relatorios":        { key: "report-center",     label: "Performance",  icon: "ChartColumn",     roles: ["admin", "gestor", "corretor", "diretor"], noPadding: true },
  "/dados-anuncios":                { key: "relatorio-origem-performance", label: "Central de Marketing", icon: "ChartColumn", roles: ["admin", "gestor", "diretor"], noPadding: true },
  "/relatorio-performance-origem":  { key: "relatorio-origem-performance", label: "Central de Marketing", icon: "ChartColumn", roles: ["admin", "gestor", "diretor"], noPadding: true },
  "/materiais":             { key: "materiais",            label: "Materiais",           icon: "FolderOpen" },
  "/materiais/analytics":   { key: "materiais-analytics",  label: "Analytics Materiais", icon: "ChartColumn",     roles: ["gestor", "admin", "diretor"] },
