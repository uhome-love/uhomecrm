...
const FALLBACK_COLORS = ["#1E2A80","#2B3BA6","#3852CC","#4969FF","#6B84FF","#8C9EFF","#A5B4FE","#BFCBFF","#D5DDFF","#E8ECFF"];
...
const MiniKpi = forwardRef<HTMLDivElement, {
  ...
  return (
    <div
      ref={ref}
      onClick={onClick}
      className={`bg-white dark:bg-[#141e30] rounded-2xl p-4 border-0 shadow-[0_2px_14px_rgba(15,23,42,0.06)] hover:shadow-[0_10px_30px_rgba(73,105,255,0.15)] transition-shadow ${onClick ? "cursor-pointer hover:border-primary/30 transition-colors" : ""}`}
    >
...
// ─── Main Page ───
export default function CeoDashboardNovoDesign() {
