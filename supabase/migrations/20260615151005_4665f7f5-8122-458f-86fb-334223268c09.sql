...
BEGIN
  ...
  VALUES (p_lead_id, v_stage_anterior, v_stage_novo_lead, v_movido_por,
    '🔄 LEAD REENGAJADO pelo template "' || v_tpl || '" — resposta positiva ao disparo. Enviado para a FILA DO CEO (distribuição manual). Origem original: ' || v_origem_atual ||
...
GRANT EXECUTE ON FUNCTION public.reativar_lead_para_fila_ceo(uuid, text) TO authenticated, service_role;