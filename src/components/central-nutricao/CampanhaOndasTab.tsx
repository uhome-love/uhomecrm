...
export default function CampanhaOndasTab() {
  ...
  const getCooldownInfo = (onda: number) => {
    ...
    return { restanteMin: Math.ceil(restanteMs / 60000) };
  };
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          <h2 className="text-xl font-bold">Campanha Átrio Boutique Haus</h2>
          <p className="text-sm text-muted-foreground">Disparo controlado em ondas via Meta Cloud API.</p>
        </div>
        ...
        <Card className="border-yellow-500/40 bg-yellow-500/5">
          <CardContent className="flex items-start gap-3 p-4 text-sm">
            ...
            <div>
              ...
              <div className="text-muted-foreground">Clique em "Preparar audiência" para selecionar e congelar os leads.</div>
            </div>
          </CardContent>
        </Card>
      )}
