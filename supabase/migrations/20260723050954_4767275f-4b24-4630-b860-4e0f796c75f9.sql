...
RETURNS TABLE(
  ...
  lead_motivo_descarte text, lead_reengajamento_status text, lead_stage_changed_at timestamptz,
  lead_score integer, lead_temperatura text, lead_created_at timestamptz,
