...
export function GreetingBar({
  ...
  return (
    <div
      className={cn(
        "relative flex items-center gap-4 rounded-[14px] bg-primary px-6 py-[18px] overflow-hidden",
        className
      )}
    >
      {/* Decoração */}
      ...
      <div className="relative z-10 min-w-0 flex-1">
        <p className="font-display text-[16px] font-extrabold tracking-[-0.3px] text-white leading-snug">
          ...
          <div className="absolute right-0 top-[calc(100%+6px)] z-50 min-w-[168px] rounded-[10px] border border-[#e8e8f0] bg-white p-1 shadow-[0_8px_24px_rgba(0,0,0,0.10),0_2px_6px_rgba(0,0,0,0.06)]">
            {(
              ...
              <button
                ...
                className={cn(
                  ...
                  filter === key && "bg-[#f0f0ff] font-semibold text-primary"
                )}
              >
                {label}
              </button>
            ...
            <button
              ...
              className={cn(
                "flex w-full items-center gap-2 rounded-[7px] px-[10px] py-2",
                "text-[13px] font-medium text-[#3f3f46] transition-colors hover:bg-[#f4f4f8]",
                filter === "personalizado" && "bg-[#f0f0ff] font-semibold text-primary"
              )}
            >
              Personalizado
            </button>
              ...
              <div className="border-t border-[#f0f0f5] mt-1 pt-2 px-1 pb-1">
                <div className="flex items-center gap-1.5">
                  <input
                    ...
                    className="h-[30px] flex-1 rounded-[6px] border border-[#e8e8f0] bg-[#f7f7fb] px-2 text-[11px] text-[#0a0a0f] outline-none focus:border-primary focus:bg-white"
                  />
                  ...
                  <button
                    ...
                    className="h-[30px] rounded-[6px] bg-primary px-2.5 text-[11px] font-semibold text-white hover:bg-primary transition-colors whitespace-nowrap"
                  >
                    OK
                  </button>
                </div>
